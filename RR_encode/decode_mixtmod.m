function [images, recons, w, n, mu] = decode_mixtmod(X, Y, trainidx, testidx, B, Sigma, priordata,T)
%
...
% Schoenmakers, S., van Gerven, M., & Heskes, T. (2014, June). Gaussian 
% mixture models improve fMRI-based image reconstruction. In Pattern Recog-
% nition in Neuroimaging, 2014 International Workshop on (pp. 1-4). IEEE.
% 
