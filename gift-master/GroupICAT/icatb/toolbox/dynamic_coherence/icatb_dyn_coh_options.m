function input_parameters = icatb_dyn_coh_options(varargin)
%% Dynamic coherence tool options
%
...
numParameters = 1;
inputParameters(numParameters).listString = 'Pre-processing Timecourses';
optionNumber = 1;
