...
try
    xlabel(plotX.xlabel, 'color', FONT_COLOR, 'HorizontalAlignment', 'center', 'fontunits', UI_FONTUNITS, 'fontname', UI_FONTNAME, 'fontSize', UI_FS - 1);
catch
end

try
    ylabel(plotX.ylabel, 'color', FONT_COLOR, 'HorizontalAlignment', 'center', 'fontunits', UI_FONTUNITS, 'fontname', UI_FONTNAME, 'fontSize', UI_FS - 1);
catch
end
