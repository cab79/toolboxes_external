    ...
    if (strcmpi(display_type, 'montage'))
        ...
        if (useColorbar)
            ...
            if ((icatb_get_matlab_version <= 2013) || strcmpi(version('-release'), '2014a'))
                ...
                title(maxLabel, 'parent', ColorbarHandle, 'color', FONT_COLOR, 'Horizontalalignment', 'center', 'fontsize', 8);
                xlabel(minLabel, 'parent', ColorbarHandle, 'color', FONT_COLOR, 'Horizontalalignment', 'center', 'fontsize', 8);
                ...
                title(maxLabel, 'parent', ColorbarHandle, 'color', FONT_COLOR, 'Horizontalalignment', 'center', 'fontsize', 8);
                set(labelsH, 'string', minLabel, 'rotation',0, 'fontsize', 8);
