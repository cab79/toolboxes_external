function regressOut = icatb_univariate_cov_sel(covariates, popupStr)
...
if (~exist('popupStr', 'var'))
    popupStr = 'Do You Want To Skip Multivariate tests?';
end
...
%if (plotPopup)
    ...
    textH = icatb_uicontrol('parent', InputHandle, 'units', 'normalized', 'style', 'text', 'position', promptPos, 'string', popupStr, 'tag', ...
