...
FNAME='m:\Matlab\NoiseTools\DATA\Fichier_1815.mat';
if ~exist(FNAME); 
    disp('file ''m:\Matlab\NoiseTools\DATA\Fichier_1815.mat'' not found, get it at http://cognition.ens.fr/Audition/adc/NoiseTools/DATA/');
    return
end

load (FNAME);   % loads LFPSampleRate, frequencies, xx
x=permute(matrice,[3 4 2 1]); clear matrice
sr=LFPSampleRate;
