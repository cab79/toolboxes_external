...
% load data
FNAME='m:\Matlab\NoiseTools\DATA\example_data.mat';
if ~exist(FNAME); 
    disp('file ''m:\Matlab\NoiseTools\DATA\example_data.mat'' not found, get it at http://cognition.ens.fr/Audition/adc/NoiseTools/DATA/');
    return
end
