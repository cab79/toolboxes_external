...
elseif nargin < 4
    ...
    if exist('chanlocs','var')
        [EEG, nbadchan, nbadtrial] = tbt_bcr2_cab(EEG,bads,badsegs,badchans,plot_bads,chanlocs);
    else
        [EEG, nbadchan, nbadtrial] = tbt_bcr2_cab(EEG,bads,badsegs,badchans,plot_bads);
    end
