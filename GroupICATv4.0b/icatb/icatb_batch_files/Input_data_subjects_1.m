...
moving_average_window = 3;%- Type of moving average window.
sorting_trials = 'no';%- Options are 'No', 'Condition & Latency'.
outFileName = 'erp';%- File name used when writing analyze or Nifti data.
outputDir = pth;% - Output directory to save analyze or Nifti data.

icatb_eeg_smooth_trials_CORE(char(erpFiles), baseLine, smoothTrials, moving_average_window, sorting_trials, outFileName, outputDir)
...
input_data_file_patterns = strrep(erpFiles,'.set','\erp.mat');
